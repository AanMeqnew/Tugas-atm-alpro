...
int balance = 500000;  // Saldo awal

void login() {
    int pin = 12150511187;
    int inputPin;
    int i;  
    printf("Selamat Datang ATM RAMADHAN ALFADRI");
    printf("\nSilahkan input pin ATM anda untuk melanjutkan\n");
    printf("==========*****==========\n");
    for (i = 0; i < 3; i++) {
    ...
    printf("Anda tidak dapat melanjutkan. Silahkan Hubungi Admin untuk keterangan lebih lanjut\n");
}
void cek_saldo() {
    printf("Saldo Anda: %d\n", balance);
}
